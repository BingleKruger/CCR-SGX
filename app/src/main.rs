        ...
        match stdin().read_line(&mut buffer) {
            Ok(_) => {
                ...
                if parsed == "Exit" {
                    ...
                    println!();
                    println!("Select the number of rows to evaluate:");
                    println!("1 - 1 000");
                    println!("2 - 10 000");
                    println!("3 - 100 000");
                    println!("4 - 1 000 000");
                    ...
                    let mut buffer_rows = String::new();
                    
                    match stdin().read_line(&mut buffer_rows) {
                        Ok(_) => {
                            let number_rows = buffer_rows.trim_end();
                            let mut retval_rows = sgx_status_t::SGX_SUCCESS;
                            let input_rows = String::from(number_rows);
                            let result = unsafe {
